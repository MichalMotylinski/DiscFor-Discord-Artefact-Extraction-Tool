...
def read_cache_entry(output_dir):
    ...
    cache_address_array = read_index(output_dir)
    data_1 = open(output_dir + "/Dumps/Cache/data_1", "rb")
    data_2 = open(output_dir + "/Dumps/Cache/data_2", "rb")
    data_3 = open(output_dir + "/Dumps/Cache/data_3", "rb")
    # Read information for each entry
    ...
    for i in cache_data_list:
        ...
        resource_data, i["File Location"] = read_resource_content(i["File Size"], i["File Location"], output_dir)
        i["MD5"], i["SHA1"], i["SHA256"] = common.extract_file(resource_data, i["Filename"], output_dir,
                                                               i["Content Encoding"])
